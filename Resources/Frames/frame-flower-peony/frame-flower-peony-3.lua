...
me:setAnchorPoint(0.0798, 0.5)
me:setScale(winSize.width*0.79198/contentSize.width)
me:setPosition(-contentSize.width + visibleOrigin.x, winSize.height*0.36575 + visibleOrigin.y)

local offset = winSize.width*0.02
local newPos = { x = visibleOrigin.x + offset, y = winSize.height*0.36575 + visibleOrigin.y }
