...
me:setAnchorPoint(0.42409, 0.5)
me:setScale(winSize.width*0.39599/contentSize.width)
me:setPosition(-contentSize.width + visibleOrigin.x, winSize.height*0.77083 + visibleOrigin.y)

local offset = winSize.width*0.02
local newPos = { x = visibleOrigin.x + offset, y = winSize.height*0.77083 + visibleOrigin.y }
