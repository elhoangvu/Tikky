...
@interface TKSNFacebookSDK () <FBSDKSharingDelegate>
...
@implementation TKSNFacebookSDK
...
- (void)userInfoWithCompletionHandler:(void (^)(TKSNUserInfo *, NSError* error))completion {
    if (!completion) {
        return;
    }
    ...
    [grapRequest startWithCompletionHandler:^(FBSDKGraphRequestConnection *connection, id result, NSError *error) {
        ...
        TKSNUserInfo* userInfo = [[TKSNUserInfo alloc] init];
